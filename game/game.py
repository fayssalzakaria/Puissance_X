import sys
import pygame
from settings.constants import SQUARESIZE, PLAYER_PIECE, AI_PIECE
from game.game_logic import create_board, is_valid_location, get_next_open_row, drop_piece, winning_move
from game.ai import get_ai_move
from ui.interface import draw_board
